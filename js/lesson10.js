...
// let num = 0;
// if (num > 0 && num <= 9) {
// 	console.log('Положительное однозначное');
// }else if (num < 0 && num >= -9) {
// 	console.log('Отрицательное однозначное');
// }else if (num >= 10 && num <= 99) {
// 	console.log('Положительное двузначное');
// }else if (num <= -10 && num >= -99) {
// 	console.log('Отрицательное двузначное');
// }else if (num >= 100 && num <= 999) {
// 	console.log('Положительное трёхзначное');
// }else if (num <= -100 && num >= -999) {
// 	console.log('отрицательное трёхзначное');
// }else if (num >= 1000) {
// 	console.log('Положительное более трёх');
// }else if (num <= -1000) {
// 	console.log('отрицательное более трёх');
// }else {
